...
<div class="container" >
    <div class="row">
      <div class="col" >
            ...
            <a class="btn btn-success" style="background-color:#60a3bc; border-color:#60a3bc;" href="{{route('serviceprice.create')}}">Create Price</a>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{route('serviceprice.edit',  $item->id)}}"><i class="fas fa fa-edit"></i></a> &nbsp;
                        <a class="text-danger" href="{{route('serviceprice.destroy', ['id'=>$item->id])}}"><i class="fas fa fa-trash-alt"></i></a>
                    </td>
                  </tr>
                @endforeach

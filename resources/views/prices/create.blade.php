                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('price.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cost_price" type="text" class="form-control @error('cost_price') is-invalid @enderror" name="cost_price" value="{{ old('cost_price') }}" required autocomplete="cost_price" autofocus>
                                @error('cost_price')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="sale_price" type="text" class="form-control @error('sale_price') is-invalid @enderror" name="sale_price" value="{{ old('sale_price') }}" required autocomplete="sale_price" autofocus>
                                    @error('sale_price')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>

...
<head>
  <meta charset="UTF-8">
  <title> Create Sales manager </title>
...
<div class="login-wrap">
	<div class="login-html">
		<input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1" class="tab">Create Sales manager</label>

                        <form method="POST" action="{{ route('salesmanager.store') }}">
                            @csrf

                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="first" class="label">{{ __('First receipt') }}</label>
                                                ...
                                                <input id="first" type="text" class="input" name="first" value="{{ old('first') }}">
                                        ...
                                        <div class="form-group">
                                            <label for="second" class="label">{{ __('Second receipt') }}</label>
                                                ...
                                                <input id="second" type="text" class="input" name="second" value="{{ old('second') }}">
                                        ...
                                        <div class="form-group">
                                            <label for="third" class="label">{{ __('Third receipt') }}</label>
                                                ...
                                                <input id="third" type="text" class="input" name="third" value="{{ old('third') }}">
